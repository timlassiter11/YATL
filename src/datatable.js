...
export class DataTable {
  ...
  constructor({
      ...
      if (this.#identityCol === undefined) {
          throw new Error("At least one column must be marked as an identity column.")
      }
  ...
  #getRowElement(index) {
    ...
    if (element == null)
      element = this.#createRowElement(row);
    return element;
  }
  ...
  #updateTable() {
      ...
      if (this.#filteredRows.length) {
          ...
          if (!virtualScroll) {
              ...
              const rowElements = this.#filteredRows
                  .map((_, index) => this.#getRowElement(index));
