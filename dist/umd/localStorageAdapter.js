(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('../datatable.js')) :
    typeof define === 'function' && define.amd ? define(['exports', '../datatable'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.yatl = {}, global.yatl));
})(this, (function (exports, datatable_js) { 'use strict';
    ...
    class LocalStorageAdapter {
        ...
        constructor(dataTable, storageKey, options = {}) {
            ...
            if (this.#options.saveColumnSorting) {
                table.addEventListener(datatable_js.DataTable.Events.COL_SORT, () => this.saveState());
            }

            if (this.#options.saveColumnVisibility) {
                table.addEventListener(datatable_js.DataTable.Events.COL_HIDE, () => this.saveState());
                table.addEventListener(datatable_js.DataTable.Events.COL_SHOW, () => this.saveState());
            }

            if (this.#options.saveColumnWidth) {
                table.addEventListener(datatable_js.DataTable.Events.COL_RESIZE, () => this.saveState());
            }

            if (this.#options.saveColumnOrder) {
                table.addEventListener(datatable_js.DataTable.Events.COL_REARRANGE, () => this.saveState());
            }
        }
